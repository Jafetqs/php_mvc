<section class="container my-5 mx-auto bg-light col-12 col-lg-6">
    <form action="<?=brl?>usuario/upd&id=<?= $usr->id_usuario?>" method="POST" enctype="multipart/form-data">
        ...
        <fieldset>
            ...
            <div class="form-group">
                <label for="fotoup" class="form-label mt-4">Actualizar foto de perfil:</label><br>
